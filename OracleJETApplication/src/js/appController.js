 ...
 */
define(['ojs/ojcore', 'knockout','signals', 'ojs/ojmodule-element-utils', 'ojs/ojmodule-element', 'ojs/ojrouter', 'ojs/ojknockout', 'ojs/ojarraytabledatasource',
  'ojs/ojoffcanvas','ojs/ojinputtext'],
  function(oj, ko,signals, moduleUtils) {
     function ControllerViewModel() {
      ...
      resolveVVM("customers", self.firstConfig);
      resolveVVM("about", self.secondConfig);
      console.log(self.userInfoSignal);
